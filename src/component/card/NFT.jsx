...
const NFT = (props) => {
    ...
    return (
        <Card>
            <Flex direction={'column'} justify={'center'} p={1}>
                <Box pos={'relative'} borderRadius={'xl'} overflow={'hidden'}>
                    <Image src={image}  alt="NFT" w={'100%'} objectFit={'cover'}/>
                    <Button
                        variant='link'
                        pos={'absolute'}
                        top={3}
                ...
                <Flex flexDirection={'column'} justify={'space-between'} h={'100%'}>
                    <Flex justify={'space-between'} direction={{base: 'row', md: 'column', lg: 'row', xl: 'column', '2xl': 'row'}} mb={'auto'}>
                        <Flex direction={'column'}>
                            <Text fontSize={{base: 'xl', md: 'lg', lg: 'lg', xl: 'lg', '2xl': 'md', '3xl': 'lg'}} mb="5px" fontWeight="bold" me="14px">
                                {name}
                            </Text>
                        ...
                        <AvatarGroup max={3} size={'sm'} mt={{base: '0px', md: '10px', lg: '0px', xl: '10px', '2xl': '0px'}} fontSize={'12px'}>
                            {bidders.map((avt,key) => (<Avatar key={key} src={avt} />))}
                        </AvatarGroup>
                    </Flex>
                    <Flex align={'start'} justify={'space-between'} direction={{base: 'row', md: 'column', lg: 'row', xl: 'column', 'wxl': 'row'}} mt={'25px'}>
